        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <p className="text-sm font-display font-bold text-foreground">Active Match Found!</p>
                <p className="text-xs text-muted-foreground">
                  You have an ongoing {activeMatch.gameType} match vs <span className="font-bold text-foreground">{activeMatch.opponentName}</span>
                </p>
              </div>
          ...
          <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.98 }} className="glass-card rounded-2xl p-5 mb-6 relative overflow-hidden group border border-primary/20 bg-primary/5">
            ...
            <div className="relative z-10">
              <p className="text-muted-foreground text-[10px] uppercase font-bold tracking-widest mb-1 flex items-center gap-1.5">
                 <Zap className="w-3 h-3 text-primary" /> Available Funds
              </p>
              ...
              <div className="flex gap-4">
                <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }} className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-foreground/80">{statsData?.wins || 0} Wins</span>
                </motion.div>
                <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.5 }} className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-foreground/80">{statsData?.winRate || 0}% Win Rate</span>
                </motion.div>
              </div>
            </div>
          </motion.div>
        ...
        <Link to="/leaderboard">
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.97 }} className="card-game rounded-2xl p-4 flex items-center justify-between border border-border/50 group">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-display font-bold text-foreground">Global Leaderboard</p>
                <p className="text-xs text-muted-foreground">Check your ranking against others</p>
              </div>
            </div>
