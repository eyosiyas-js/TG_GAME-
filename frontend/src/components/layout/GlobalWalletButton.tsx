    ...
    <div className="fixed top-4 right-4 z-50 pointer-events-auto">
      ...
      >
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <span className="text-[13px] font-black text-foreground leading-none">{Number(balance || 0).toLocaleString()} <span className="text-[10px] text-muted-foreground">ETB</span></span>
        </div>
      </a>
    </div>
  );
